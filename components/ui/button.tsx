  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        default:
          "bg-withe text-black border-slate-200 border-2 border-b-[4px] active:border-b-2 hover:bg-slate-100 text-slate-500 ",
        ...
        secondary:
          "bg-blue-700 text-primary-foreground hover:bg-blue-700/90 border-blue-800 border-b-4 active:border-b-0",
        secondaryOutline:
          "bg-white text-blue-700 hover:bg-slate-100",
        danger:
          "bg-rose-700 text-primary-foreground hover:bg-rose-700/90 border-rose-800 border-b-4 active:border-b-0",
        dangerOutline:
          "bg-white text-rose-700 hover:bg-slate-100",
        super:
          "bg-fuchsia-400 text-primary-foreground hover:bg-fuchsia-400/90 border-fuchsia-500 border-b-4 active:border-b-0",
        superOutline:
          "bg-white text-fuchsia-400 hover:bg-slate-100",
        ghost:
          "bg-transparent text-slate-500 border-transparent border-0 hover:bg-slate-100",
        link: "text-primary underline-offset-4 hover:underline",
        sidebar: "bg-transparent text-slate-500 border-2 border-trasparent hover:bg-slate-100 trasition-none",
        sidebarOutline: "bg-sky-500/15 text-sky-500 border-2 border-sky-500 hover:bg-sky-500/20 transition-none",
      },
      size: {
